...
Есть личный кабинет на reg.ru

> 2. Вы зарезистрировали домен и можете им управлять (редактировать dns записи в рамках этого домена).

Есть домен catabasis.site, который, скорее всего, сгинет к январю 2023 года, потому что 
продлевать его большого смысла не вижу.
